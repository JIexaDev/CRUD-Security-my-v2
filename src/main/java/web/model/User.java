...
public class User implements UserDetails {
    ...
    @Size(min = 2, max = 60, message = "Login should be between 2 and 20 characters")
    ...
    @Size(min = 2, max = 60, message = "Name should be between 2 and 20 characters")
    private String name;

    @Column(name = "surname", nullable = false, length = 60)
    @NotBlank(message = "Surname should not be empty")
    @Size(min = 2, max = 60, message = "Surname should be between 2 and 30 characters")
